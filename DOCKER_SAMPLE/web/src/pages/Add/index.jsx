...
const Add = () => {
  ...
  const onClickIncreaseDecrease = (condition = "") => {
    if (parseInt(user?.account?.power)) {
  ...
  return (
    <>
      ...
      <HomeHeader text={"Create a video and empower it with coins for others to see it"} />
          ...
          <form onSubmit={handleSubmit(onSubmitForm)}>
            ...
            <div className="form-group">
              <div className="videoContent">
                ...
                <p>
                  <strong>Example</strong>: Empowering your video with 10 coins will make 10
                  people see your video from beginning to end{" "}
                </p>
              </div>
            </div>
