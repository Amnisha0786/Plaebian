...
const EditProfile = () => {
  ...
  const onSubmit = async (data) => {
    ...
    trigger(
      API_END_POINTS.UPDATE_USER_PROFILE,
      body,
      () => {
        navigate("/settings");
      },
  ...
  return (
    <div>
      <HomeHeader text={"Edit Profile"} />
      <div className="">
        <div className={`${styles.rejected_city} mt-4`}>
          <div className={`${styles.signUp} ${styles.editProfile}`}>
            <h2>Edit Profile</h2>
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className={`${styles.formgroup} ${styles.city_form}`}>
                <label>City</label>
                <Controller
                  name="city"
                  control={control}
